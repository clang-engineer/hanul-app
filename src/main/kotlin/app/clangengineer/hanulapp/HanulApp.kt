...
import app.clangengineer.hanulapp.config.ApplicationProperties
import app.clangengineer.hanulapp.config.CRLFLogConverter
...
class HanulApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes hanulApp.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<HanulApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(HanulApp::class.java)
