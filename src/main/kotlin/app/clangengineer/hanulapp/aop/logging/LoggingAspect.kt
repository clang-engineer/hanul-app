package app.clangengineer.hanulapp.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(app.clangengineer.hanulapp.repository..*)" +
            " || within(app.clangengineer.hanulapp.service..*)" +
            " || within(app.clangengineer.hanulapp.web.rest..*)"
    )
