    ...
    <Row>
      <Col md="8">
        <h2 data-cy="pointDetailsHeading">
          <Translate contentKey="hanulApp.point.detail.title">Point</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="title">
              <Translate contentKey="hanulApp.point.title">Title</Translate>
            </span>
          </dt>
          <dd>{pointEntity.title}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="hanulApp.point.description">Description</Translate>
            </span>
          </dt>
          <dd>{pointEntity.description}</dd>
          <dt>
            <span id="activated">
              <Translate contentKey="hanulApp.point.activated">Activated</Translate>
            </span>
          </dt>
