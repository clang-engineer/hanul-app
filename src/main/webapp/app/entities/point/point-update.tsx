  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hanulApp.point.home.createOrEditLabel" data-cy="PointCreateUpdateHeading">
            <Translate contentKey="hanulApp.point.home.createOrEditLabel">Create or edit a Point</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hanulApp.point.title')}
                id="point-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('hanulApp.point.description')}
              ...
              />
              <ValidatedField
                label={translate('hanulApp.point.activated')}
                id="point-activated"
                name="activated"
                data-cy="activated"
                check
