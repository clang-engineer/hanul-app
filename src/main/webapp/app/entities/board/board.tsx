  ...
  return (
    <div>
      <h2 id="board-heading" data-cy="BoardHeading">
        <Translate contentKey="hanulApp.board.home.title">Boards</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hanulApp.board.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/board/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hanulApp.board.home.createLabel">Create new Board</Translate>
          </Link>
        </div>
      </h2>
        ...
        {boardList && boardList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hanulApp.board.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="hanulApp.board.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="hanulApp.board.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('activated')}>
                  <Translate contentKey="hanulApp.board.activated">Activated</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {boardList.map((board, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{board.activated ? 'true' : 'false'}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hanulApp.board.home.notFound">No Boards found</Translate>
            </div>
          )
        )}
      </div>
